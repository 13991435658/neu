...
router.post('/api/creategroup',userCtrl.creategroup)
router.get('/api/grouplist',userCtrl.getGrouplist)
router.post('/api/addunread',userCtrl.unreadAdd)
router.post('/api/read',userCtrl.read)
